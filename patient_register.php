...
<html>
	...
	<body>
		...
		<div class="jumbotron">
            ...
            <p>Provide details to create patient profile with us!</p>
		</div>
		<section class="my-5">
			<div class="container-fluid">
            <div class="row">
					...
					<form role="form" method="post" id="reused_form">
		                <div class="row">
		                    <div class="col-sm-6 form-group">
		                        <label for="name">Patient Email Address:</label>
		                ...
		                <div class="row">
		                    ...
		                    <div class="col-sm-6 form-group">
		                        <label for="name">Patient Date of Birth</label>
		                        <input type="text" class="form-control" id="consultedfor" name="consultedfor" maxlength="50">
		                    </div>
		                </div>
		                 <div class="row">
		                 ...
		                 <div class="row">
		                    <div class="col-sm-6 form-group">
		                        <label for="name">Patient Maritial Status:</label>
		                        <input type="text" class="form-control" id="consultedfor" name="consultedfor" maxlength="50">
		                    </div>	
		                    <div class="col-sm-6 form-group">
		                        <label for="name">Patient Complete Address:</label>
		                        <input type="text" class="form-control" id="consultedfor" name="consultedfor" maxlength="50">
		                    </div>
		                </div>
		                ...
		                <div class="row">
		                    <div class="col-sm-12 form-group">
		                        <a href="patient_login.php" type="submit" class="btn btn-lg btn-success btn-block" id="btnFeedback">Sign Up</a>
		                    </div>
		                </div>		               
		            </form>
		        ...
		        <div class="col-lg-6 col-md-6 col-12">
		        	<img src="images/patient_login.jpg" class="img-fluid aboutimg">
		        </div>
		    </div>
			</div>
		</section>

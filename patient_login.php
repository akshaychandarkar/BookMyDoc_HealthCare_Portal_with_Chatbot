            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12">
					<form role="form" method="post" id="reused_form">
		                ...
		                <div class="row">
		                    <div class="col-sm-12 form-group">
		                        <button type="submit" class="btn btn-lg btn-success btn-block" id="btnFeedback">Login</button>
		                    </div>
		                </div>
		                <div class="row">
		                    <div class="col-sm-12 form-group">
		                        <a href="patient_register.php" type="submit" class="btn btn-lg btn-success btn-block"  id="btnFeedback">Register</a>
		                    </div>
		                </div>			               
		            </form>

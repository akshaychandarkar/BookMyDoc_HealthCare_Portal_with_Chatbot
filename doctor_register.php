...
<html>
	...
	<body>
		...
		<div class="jumbotron">
            ...
            <p>Provide details to create Doctor profile with us to consult patients!</p>
		</div>
		<section class="my-5">
			<div class="container-fluid">
            <div class="row">
					...
					<form role="form" method="post" id="reused_form">
		                <div class="row">
		                    <div class="col-sm-6 form-group">
		                        <label for="name"> Doctor Email Address:</label>
		                        <input type="text" class="form-control" id="fullname" name="fullname" maxlength="50">
		                    </div>
		                    <div class="col-sm-6 form-group">
		                        <label for="name"> Doctor Password:</label>
		                ...
		                <div class="row">
		                 ...
		                 <div class="row">
		                    ...
		                    <div class="col-sm-6 form-group">
		                        <label for="name"> Doctor Date of Birth:</label>
		                        <input type="text" class="form-control" id="consultedfor" name="consultedfor" maxlength="50">
		                    </div>
		                </div>
		                ...
		                <div class="row">
		                    <div class="col-sm-12 form-group">
		                        <a href="doctor_login.php" type="submit" class="btn btn-lg btn-success btn-block" id="btnFeedback">Sign Up</a>
		                    </div>
		                </div>		               
		            </form>
